...
//   id
// }
// pairDayDatas(first: 2, orderBy: date, orderDirection: desc, where: { pairAddress_in: ${poolIds} }) {
//   date
//   dailyVolumeUSD
// }
// quarterYearLiquidityData: pairDayDatas(first: 2, orderBy: date, orderDirection: desc, where: { pairAddress_in: ${poolIds} }) {
//   date
//   reserveUSD
// }
// quarterYearVolumeData: pairDayDatas(first: 2, orderBy: date, orderDirection: desc, where: { pairAddress_in: ${poolIds} }) {
//   date
//   dailyVolumeUSD
// }
// }
